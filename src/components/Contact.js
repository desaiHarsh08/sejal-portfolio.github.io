...
export default function Contact() {
  return (
    <>
        ...
        <div className='contact py-20 mx-2 z-[2]'>
            <h2 className='text-3xl underline font-semibold text-center'>Contact me</h2>
        ...
        <div className="content bg-[#fff] border-red-500  pt-5 md:pr-[60px] pb-10  flex justify-center items-center flex-col-reverse lg:flex-row">
          ...
          <div className="right lg:w-3/4 sm:w-full h-full lg:px-7">
            ...
            <form action="https://script.google.com/macros/s/AKfycbxS8NwH1MfO5YWZHgucOI8F_4LGSVa1GewYOPjREmeJIy4aE-mMyoWQ1MjErxDRPT1l/exec" method='POST'>
